...
- 🟢 **Building:** Production-ready AI pipelines and multi-agent systems automating 5+ step workflows  
- ⚙ **Specializing in:** RAG systems, LLM orchestration, and agentic architectures with tool usage, memory, and self-correction  
- 💼 **Open to:** AI/ML Engineering, Backend, or Data roles where I can build **scalable AI systems with measurable impact**  
- 💬 **Core strengths:** Python, SQL, APIs, prompt engineering, system design for LLM-based applications  
...
**Impact:**
- 3 modular agents (planner, validator, enhancer) handle 10+ decision paths  
- Reduces manual planning time by ~80%  
- Demo: ![Demo GIF](link-to-gif)  
...
**Impact:**
- Automates 5+ step claim resolution workflows  
- Handles X+ claim scenarios autonomously  
- Demo: ![Demo GIF](link-to-gif)  
...
<p align="center">
  <i>The best systems - and the best careers - are built one curious experiment at a time.</i>
</p>
